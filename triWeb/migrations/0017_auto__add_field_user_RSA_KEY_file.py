...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.RSA_KEY_file'
        db.add_column(u'triWeb_user', 'RSA_KEY_file',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=100),
                      keep_default=False)

        # Adding M2M table for field access_ip_list on 'User'
        db.create_table(u'triWeb_user_access_ip_list', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('user', models.ForeignKey(orm[u'triWeb.user'], null=False)),
            ('ip', models.ForeignKey(orm[u'triWeb.ip'], null=False))
        ))
        db.create_unique(u'triWeb_user_access_ip_list', ['user_id', 'ip_id'])


    def backwards(self, orm):
        # Deleting field 'User.RSA_KEY_file'
        db.delete_column(u'triWeb_user', 'RSA_KEY_file')

        # Removing M2M table for field access_ip_list on 'User'
        db.delete_table('triWeb_user_access_ip_list')
    ...
    models = {
        ...
        u'triWeb.hostlog': {
            ...
            'result': ('django.db.models.fields.CharField', [], {'default': "'unkown'", 'max_length': '30'}),
        ...
        u'triWeb.multiruncounter': {
            'Meta': {'object_name': 'MultiRunCounter'},
        ...
        u'triWeb.user': {
            ...
            'RSA_KEY_file': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'access_ip_list': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['triWeb.IP']", 'symmetrical': 'False'}),
