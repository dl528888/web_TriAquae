...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MultiRunCounter'
        db.create_table(u'triWeb_multiruncounter', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('counter', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'triWeb', ['MultiRunCounter'])


    def backwards(self, orm):
        # Deleting model 'MultiRunCounter'
        db.delete_table(u'triWeb_multiruncounter')
