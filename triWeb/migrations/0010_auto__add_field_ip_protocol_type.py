...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IP.protocol_type'
        db.add_column('triWeb_ip', 'protocol_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['triWeb.ConnectionMethod'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IP.protocol_type'
        db.delete_column('triWeb_ip', 'protocol_type_id')
    ...
    models = {
        ...
        'triWeb.ip': {
            ...
            'protocol_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['triWeb.ConnectionMethod']", 'null': 'True'}),
