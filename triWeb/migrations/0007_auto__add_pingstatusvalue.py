...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PingStatusValue'
        db.create_table('triWeb_pingstatusvalue', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ip', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['triWeb.IP'])),
            ('check_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('ping_value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2)),
        ))
        db.send_create_signal('triWeb', ['PingStatusValue'])


    def backwards(self, orm):
        # Deleting model 'PingStatusValue'
        db.delete_table('triWeb_pingstatusvalue')
