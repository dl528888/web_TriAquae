...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HostLog.cmd'
        db.add_column(u'triWeb_hostlog', 'cmd',
                      self.gf('django.db.models.fields.TextField')(default='Test Command.....'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HostLog.cmd'
        db.delete_column(u'triWeb_hostlog', 'cmd')
