...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HostLog.user'
        db.add_column(u'triWeb_hostlog', 'user',
                      self.gf('django.db.models.fields.CharField')(default='TestUser', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HostLog.user'
        db.delete_column(u'triWeb_hostlog', 'user')
